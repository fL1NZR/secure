...
if (isset($_POST['buy']) && isset($_SESSION['user'])) {
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        die("<p style='color:red;'>⛔ CSRF токен неверен! Атака заблокирована.</p>");
    }
...
<h2>Магазин игр (ЗАЩИЩЕННАЯ ВЕРСИЯ)</h2>
...
<p><small>Токен: <?= substr($_SESSION['csrf_token'], 0, 10) ?>...</small></p>